...
- ssr related config - missing part ([405bd61](https://github.com/Luizgomess/zardui-ci-tests/commit/405bd61))
...
- static app font ([e81bc1e](https://github.com/Luizgomess/zardui-ci-tests/commit/e81bc1e))
...
- providezard darkmode init ([5459799](https://github.com/Luizgomess/zardui-ci-tests/commit/5459799))
...
- additional AI fix for foutc ([b7318eb](https://github.com/Luizgomess/zardui-ci-tests/commit/b7318eb))
...
- additional AI fix for foutc ([15f8638](https://github.com/Luizgomess/zardui-ci-tests/commit/15f8638))
...
- AI fix for foutc ([4da2d1b](https://github.com/Luizgomess/zardui-ci-tests/commit/4da2d1b))
